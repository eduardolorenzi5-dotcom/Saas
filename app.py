...
def enviar_wpp_boas_vindas(whatsapp, nome, cliente_id=None):
    ...
    mensagem = (
        f"Olá, *{nome}*! 👋\n\n"
        f"Seja bem-vindo ao *Controla Fácil*! 🎉\n"
        f"Sou seu assistente financeiro pessoal, aqui mesmo no WhatsApp.\n\n"
        f"Você tem *7 dias grátis* para testar tudo — sem cartão, sem compromisso.\n\n"
        f"━━━━━━━━━━━━━━━━\n"
        ...
        f"📅 *Veja seus compromissos do dia:*\n"
        f"_\"Meus compromissos hoje\"_\n\n"
...
@app.route("/api/contas/<int:conta_id>/relatorio")
@login_required
def relatorio_por_conta(conta_id):
    """
